resource "aws_ec2_client_vpn_endpoint" "this" {
  ...
  server_certificate_arn = "arn:aws:acm:us-east-1:160945804984:certificate/dd6d92d2-708d-440e-9a85-7b6ac2db0fbb"

  authentication_options {
    type = "certificate-authentication"
    root_certificate_chain_arn = "arn:aws:acm:us-east-1:160945804984:certificate/0385ed14-5111-4213-a459-8dbf5bacbf1e"
  }
